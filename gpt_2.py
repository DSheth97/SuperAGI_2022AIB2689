...
Original file is located at
    https://colab.research.google.com/drive/1jextB16UXBXXdMDM-D5U5ykKddHiHEn9
"""
...
gpt_model = Transformer(layers=12, seq_len =64, heads=16, dims=1024,
                          rate=4, pad_idx=0, words=50000)
